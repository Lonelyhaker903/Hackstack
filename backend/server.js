...
// Route Definitions
app.use('/api/auth', loginRoutes); // Auth routes (secondlogin) for student login
app.use('/api/registration', registrationRoutes); //  student hackathon registrations in student dashboard
app.use('/api/hackathon', hackathon_submissionroutes); // Hackathon routes for hackathon submission student dashboard
...
app.use('/api/hoster', authRoutes); // Auth routes (hoster_homepage) for hoster login
