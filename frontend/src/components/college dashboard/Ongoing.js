...
const StudentList = ({ setStudentsCount }) => {
    ...
    useEffect(() => {
      fetch("http://localhost:5002/api/auth/users")
        ...
        .then((data) => {
          ...
          setStudentsCount(data.length); // Pass the count to the parent
        })
    ...
    return (
        <div>
            ...
            <div className="student-count">
                <strong>Total Students Registered:</strong> {studentCount}
            </div>
                        ...
                        users.map((user, index) => (
                            <tr key={user.email}>
                                ...
                                <td>
                                    <input
                                        type="file"
                                        onChange={(e) => handleFileChange(e, user.studentId)}
                                    />
                                </td>
                                <td>
